...
new.thy1.numbered.ids <- c("0_Areg ILC2", "1_IL-13 ILC2", "2_IL-10 ILC2", "3_Quiescent ILC2", "4_KLRG1 ILC2", "5_LTB ILC2", "6_T", "7_NK", "8_ILC1", "9_T", "10_HSC", "11_ST2 NK", "12_T")
...
new.thy1.ids <- c("Areg ILC2", "IL-13 ILC2", "IL-10 ILC2", "Quiescent ILC2", "KLRG1 ILC2", "LTB ILC2", "Tcm", "NK", "ILC1", "Teff", "HSC", "ST2 NK", "Tem")
...
Effector_function <- DotPlot(ILC, features = Effector_markers, group.by = "treatment", assay = "RNA", cols = "RdBu") + theme(axis.title = element_blank(), legend.title = element_text(size = 8, face ="bold"), legend.text = element_text(size = 8), axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1)) +
  coord_flip() +
  ggtitle("Ovarall effector function genes")
